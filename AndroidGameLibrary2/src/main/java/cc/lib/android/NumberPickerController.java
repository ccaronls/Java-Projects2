...
public class NumberPickerController implements OnValueChangeListener {
     ...
     * @return
     */
    protected String formatLeftPicker(int value) {
     ...
     * @return
     */
    protected String formatCenterPicker(int value) {
        return formatPicker(value);
    }
     ...
     * @return
     */
    protected String formatRightPicker(int value) {
        return formatPicker(value);
    }
     ...
     * @return
     */
    protected String formatPicker(int value) {
