...
class WolfTheGhostDoor : ZQuest(ZQuests.The_Ghost_Door) {
	...
	override val tiles: Array<ZTile>
		get() = arrayOf(
			ZTile("1R", 0, ZTile.getQuadrant(0, 0)),
			ZTile("9V", 270, ZTile.getQuadrant(0, 3)),
			ZTile("3V", 90, ZTile.getQuadrant(0, 6)),
			ZTile("2R", 90, ZTile.getQuadrant(3, 0)),
			ZTile("10R", 180, ZTile.getQuadrant(3, 3)),
			ZTile("5R", 270, ZTile.getQuadrant(3, 6)),
			ZTile("6V", 0, ZTile.getQuadrant(6, 0)),
			ZTile("8R", 180, ZTile.getQuadrant(6, 3)),
			ZTile("7V", 270, ZTile.getQuadrant(6, 6))
		)
