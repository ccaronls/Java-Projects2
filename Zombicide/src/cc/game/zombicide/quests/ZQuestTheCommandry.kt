...
open class ZQuestTheCommandry(quests: ZQuests = ZQuests.The_Commandry) : ZQuest(quests) {
	...
	override val tiles: Array<ZTile>
		get() = arrayOf(
			ZTile("4R", 180, ZTile.getQuadrant(0, 0)),
			ZTile("6R", 270, ZTile.getQuadrant(0, 3)),
			ZTile("5R", 270, ZTile.getQuadrant(0, 6)),
			ZTile("7R", 90, ZTile.getQuadrant(3, 0)),
			ZTile("8R", 180, ZTile.getQuadrant(3, 3)),
			ZTile("9R", 180, ZTile.getQuadrant(3, 6)))
