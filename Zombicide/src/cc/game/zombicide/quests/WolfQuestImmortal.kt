...
class WolfQuestImmortal : ZQuest(ZQuests.Immortal) {
	...
	override val tiles: Array<ZTile>
		get() = arrayOf(
			ZTile("11R", 0, ZTile.getQuadrant(0, 0)),
			ZTile("3V", 90, ZTile.getQuadrant(0, 3)),
			ZTile("6R", 0, ZTile.getQuadrant(3, 0)),
			ZTile("10V", 180, ZTile.getQuadrant(3, 3)),
			ZTile("8V", 270, ZTile.getQuadrant(6, 0)),
			ZTile("1V", 180, ZTile.getQuadrant(6, 3))
		)
