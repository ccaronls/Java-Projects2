...
arrayOf("z59:i:we:red", "z60", "z61",                           "z62", "z63", "z64",                                "z65", "z66", "z67:spe")))
	...
	override val tiles: Array<ZTile>
		get() = arrayOf( //9V
			ZTile("8V", 0, ZTile.getQuadrant(0, 0)),
			ZTile("3R", 270, ZTile.getQuadrant(0, 3)),
			ZTile("4V", 90, ZTile.getQuadrant(0, 6)),
			ZTile("7R", 180, ZTile.getQuadrant(3, 0)),
			ZTile("6R", 270, ZTile.getQuadrant(3, 3)),
			ZTile("5R", 90, ZTile.getQuadrant(3, 6)),
			ZTile("2R", 0, ZTile.getQuadrant(6, 0)),
			ZTile("1V", 270, ZTile.getQuadrant(6, 3)),
			ZTile("9V", 270, ZTile.getQuadrant(6, 6)))
