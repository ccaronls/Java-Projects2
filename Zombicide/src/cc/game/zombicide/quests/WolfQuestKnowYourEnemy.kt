...
arrayOf("z38:i:odn:we", "z39", "z40",                       "z41", "z42", "z43"))
	...
	override val tiles: Array<ZTile>
		get() = arrayOf(
			ZTile("9V", 270, ZTile.getQuadrant(0, 0)),
			ZTile("11R", 90, ZTile.getQuadrant(0, 3)),
			ZTile("4R", 180, ZTile.getQuadrant(3, 0)),
			ZTile("6R", 0, ZTile.getQuadrant(3, 3)),
			ZTile("1R", 0, ZTile.getQuadrant(6, 0)),
			ZTile("10V", 180, ZTile.getQuadrant(6, 3)))
