...
class ZQuestTheEvilTemple : ZQuest(ZQuests.The_Evil_Temple) {
	...
	override val tiles
		get() = arrayOf(
			ZTile("8R", 180, ZTile.getQuadrant(0, 0)),
			ZTile("9V", 180, ZTile.getQuadrant(0, 3)),
			ZTile("1V", 270, ZTile.getQuadrant(0, 6)),
			ZTile("5R", 180, ZTile.getQuadrant(3, 0)),
			ZTile("4R", 90, ZTile.getQuadrant(3, 3)),
