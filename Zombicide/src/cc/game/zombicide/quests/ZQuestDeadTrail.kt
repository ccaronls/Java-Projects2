...
class ZQuestDeadTrail : ZQuest(ZQuests.Dead_Trail) {
	...
	override val tiles: Array<ZTile>
		get() = arrayOf(
			ZTile("5V", 0, ZTile.getQuadrant(0, 0)),
			ZTile("1R", 90, ZTile.getQuadrant(0, 3)),
			ZTile("2R", 0, ZTile.getQuadrant(0, 6)),
			ZTile("3V", 90, ZTile.getQuadrant(3, 0)),
			ZTile("6V", 0, ZTile.getQuadrant(3, 3)),
			ZTile("4R", 90, ZTile.getQuadrant(3, 6)))
