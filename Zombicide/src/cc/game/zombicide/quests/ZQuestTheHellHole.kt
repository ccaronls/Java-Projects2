...
import cc.game.zombicide.ZSurvivor
...
class ZQuestTheHellHole : ZQuest(ZQuests.The_Hell_Hole) {
	...
	override val tiles: Array<ZTile>
		get() = arrayOf(
			...
			ZTile("9R", 180, ZTile.getQuadrant(0, 3)),
			ZTile("8V", 90, ZTile.getQuadrant(0, 6)),
			ZTile("2R", 0, ZTile.getQuadrant(3, 0)),
			ZTile("1V", 270, ZTile.getQuadrant(3, 3)),
			ZTile("6V", 270, ZTile.getQuadrant(3, 6)))
