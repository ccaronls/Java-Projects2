...
arrayOf("z36:blspw", "z37", "z38",                              "z39", "z40", "z41",                                "z42", "z35:t3:rw", "z35:t3:"))
	...
	override val tiles: Array<ZTile>
		get() = arrayOf(
			ZTile("8R", 0, ZTile.getQuadrant(0, 0)),
			ZTile("5R", 0, ZTile.getQuadrant(0, 3)),
			ZTile("3V", 180, ZTile.getQuadrant(0, 6)),
			ZTile("10V", 180, ZTile.getQuadrant(3, 0)),
			ZTile("9V", 270, ZTile.getQuadrant(3, 3)),
			ZTile("11V", 90, ZTile.getQuadrant(3, 6))
		)
