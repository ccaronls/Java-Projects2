...
arrayOf("z41:v:vd1:wn:ww", "z41:v:wn", "z41:v:wn:vd2:we",           "z42", "z43", "z44",                        "z45:v:gvd1:ww:wn", "z45:v:wn", "z45:v:wn:we:gvd2"))
	...
	override val tiles: Array<ZTile>
		get() = arrayOf(
			ZTile("2R", 270, ZTile.getQuadrant(0, 0)),
			ZTile("9V", 90, ZTile.getQuadrant(0, 3)),
			ZTile("3V", 0, ZTile.getQuadrant(0, 6)),
			ZTile("10V", 270, ZTile.getQuadrant(3, 0)),
			ZTile("6X", 0, ZTile.getQuadrant(3, 3, 3, 4)),
			ZTile("11R", 270, ZTile.getQuadrant(3, 6))
		)
	...
	override fun getPercentComplete(game: ZGame): Int {
		...
		val numAtUltraRed = game.allCharacters.count { it.skillLevel.isUltra }
	...
	override fun getObjectivesOverlay(game: ZGame): Table {
		val numPlayers = game.allCharacters.size
		val numAtUltraRed = game.allCharacters.count { pl -> pl.skillLevel.isUltra }
