 ...
 *
 */
public class YahtzeeRules extends Reflector<YahtzeeRules> {

	
	static {
		addAllFields(YahtzeeRules.class);
	}
	
	private int numRollsPerRound = 3;
	private int numDicePerRoll  = 5;
	private int yahtzeeBonusScore = 100; // bonus for subsequent yahtzees
	private int upperBonusPoints = 50;
	private int upperScoreForBonus = 63; // min score in upper range to achieve bonus
	private boolean enableAlternateVersion = false;
	private int numDiceSides = 6;
	
	public final int getNumRollsPerRound() {
		return numRollsPerRound;
	}
	public final void setNumRollsPerRound(int numRollsPerRound) {
		this.numRollsPerRound = numRollsPerRound;
	}
	public final int getNumDicePerRoll() {
		return numDicePerRoll;
	}
	public final void setNumDicePerRoll(int numDicePerRoll) {
		this.numDicePerRoll = numDicePerRoll;
	}
	public final int getYahtzeeBonusScore() {
		return yahtzeeBonusScore;
	}
	public final void setYahtzeeBonusScore(int yahtzeeBonusScore) {
		this.yahtzeeBonusScore = yahtzeeBonusScore;
	}
	public final int getUpperBonusPoints() {
		return upperBonusPoints;
	}
	public final void setUpperBonusPoints(int upperBonusPoints) {
		this.upperBonusPoints = upperBonusPoints;
	}
	public final int getUpperScoreForBonus() {
		return upperScoreForBonus;
	}
	public final void setUpperScoreForBonus(int upperScoreForBonus) {
		this.upperScoreForBonus = upperScoreForBonus;
	}
	public final boolean isEnableAlternateVersion() {
		return enableAlternateVersion;
	}
	public final void setEnableAlternateVersion(boolean enableAlternateVersion) {
		this.enableAlternateVersion = enableAlternateVersion;
	}
	public final int getNumDiceSides() {
		return numDiceSides;
	}
	public final void setNumDiceSides(int numDiceSides) {
