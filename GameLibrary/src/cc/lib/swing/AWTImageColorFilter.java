 ...
 *
 */
public class AWTImageColorFilter extends RGBImageFilter {
	 ...
	 * @param variance
	 */
	public AWTImageColorFilter(int oldColor, int newColor, int variance) {
	 ...
	 * @param variance
	 */
	public AWTImageColorFilter(Color oldColor, int newColor, int variance) {
	 ...
	 * @param variance
	 */
	public AWTImageColorFilter(Color oldColor, Color newColor, int variance) {
	 ...
	 * @param newColor
	 */
	public AWTImageColorFilter(Color oldcolor, Color newColor) {
