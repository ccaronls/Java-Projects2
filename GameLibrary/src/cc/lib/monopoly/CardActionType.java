...
public enum CardActionType {
    ...
    CH_ADVANCE_RR("ADVANCE TO THE NEAREST RAILROAD. If UNOWNED, you may buy from the bank. If OWNED, pay owner twice the rental to which they are otherwise entitled."),
    CH_ADVANCE_RR2("ADVANCE TO THE NEAREST RAILROAD. If UNOWNED, you may buy from the bank. If OWNED, pay owner twice the rental to which they are otherwise entitled."),
