...
public enum CardActionType {
    ...
    CH_ADVANCE_RR("ADVANCE TO THE NEAREST RAILROAD. If UNUWNOWED, you may buy from the bank. If OWNED, pay owner twice the rental to which they are otherwise entitled."),
    CH_ADVANCE_RR2("ADVANCE TO THE NEAREST RAILROAD. If UNUWNOWED, you may buy from the bank. If OWNED, pay owner twice the rental to which they are otherwise entitled."),
    CH_ADVANCE_ILLINOIS("ADVANCE TO ILLINOIS AVE. If you pass go collect $200."),
    CH_ADVANCE_TO_NEAREST_UTILITY("ADVANCE TO THE NEAREST UTILITY. If UNUWNOWED, you may buy from the bank. If OWNED, pay owner twice the rental to which they are otherwise entitled."),
    CH_ADVANCE_READING_RR("TAKE A TRIP TO READING RAILROAD. If you pass go collect $200."),
    ...
    CC_BIRTHDAY("ITS YOUR BIRTHDAY. COLLECT $10 FFROM EACH PLAYER."),
