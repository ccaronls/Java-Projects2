...
//		g.textHeight = 16f
	...
	open fun drawPropertyCard(g: AGraphics, property: Square, w: Float, h: Float) {
		var w = w
		var h = h
		val padding = w / 15
		g.pushMatrix()
		g.color = GColor.WHITE
		g.drawFilledRect(0f, 0f, w, h)
		g.color = property.color
		val BANNER_HEIGHT = h / 5
		val oldTextHeight = g.textHeight
		g.textHeight = BANNER_HEIGHT / 3
		g.drawFilledRect(0f, 0f, w, BANNER_HEIGHT)
	...
	""".trimIndent())
			...
			throw AssertionError("Dont know how to draw: $property")
		}
		g.popMatrix()
	}
