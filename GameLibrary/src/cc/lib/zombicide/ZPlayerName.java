...
public enum ZPlayerName implements IButton {
    ...
    Baldric("Magician",
            toArray(ZWeaponType.MANA_BLAST), //, ZWeaponType.LIGHTNING_BOLT, ZWeaponType.INFERNO, ZWeaponType.FIREBALL, ZWeaponType.EARTHQUAKE), //, (ZEquipmentType)ZSpellType.SPEED),
    ...
    Samson("Dwarf",
            toArray(ZWeaponType.AXE), //, (ZEquipmentType)ZItemType.DRAGON_BILE, (ZEquipmentType)ZItemType.TORCH),
            toArray(ZArmorType.SHIELD),
