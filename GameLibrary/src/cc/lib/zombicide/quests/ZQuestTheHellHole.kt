...
public class ZQuestTheHellHole extends ZQuest {
    ...
    public ZTile[] getTiles() {
        return new ZTile[] {
                ...
                new ZTile("9R", 180, ZTile.getQuadrant(0, 3)),
                new ZTile("8V", 90, ZTile.getQuadrant(0, 6)),
                new ZTile("2R", 0, ZTile.getQuadrant(3, 0)),
                new ZTile("1V", 270, ZTile.getQuadrant(3, 3)),
                new ZTile("6V", 270, ZTile.getQuadrant(3, 6)),
        };
    }
