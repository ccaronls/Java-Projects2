...
public class WolfTheGhostDoor extends ZQuest {
    ...
    public Table getObjectivesOverlay(ZGame game) {
        ...
        return new Table(getName()).addRow(new Table().setNoBorder()
            ...
            .addRow("3.", "Each OBJECTIVE grants " + getObjectiveExperience(0,0) + " points and allow survivor to take an equipment card of their choice form the deck as well as reorganize their inventory for free", String.format("%d of %d", getNumUnfoundObjectives(), getNumStartRedObjectives()))
        );
    }
}
