...
public class ZQuestTheShepherds extends ZQuest {
    ...
    public ZTile[] getTiles() {
        return new ZTile[] {
                new ZTile("1R", 90, ZTile.getQuadrant(0, 0)),
                new ZTile("2R", 180, ZTile.getQuadrant(0, 3)),
                new ZTile("9V", 270, ZTile.getQuadrant(0, 6)),
                new ZTile("3V", 0, ZTile.getQuadrant(3, 0)),
                new ZTile("4V", 270, ZTile.getQuadrant(3, 3)),
                new ZTile("5R", 180, ZTile.getQuadrant(3, 6)),
        };
    }
