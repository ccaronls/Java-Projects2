...
public enum  ZSpellType implements ZEquipmentType<ZSpell>, IButton {
    ...
    SPEED(ZSkill.Speed, "Once per turn select a survivor in a zone without zombies. He may emmidiately perform a free move action up to 2 zones.") {
        @Override
    ...
    public void doEnchant(ZGame game, ZCharacter target) {
        target.availableSkills.add(skill);
    }
}
