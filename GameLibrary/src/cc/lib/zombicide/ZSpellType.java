...
public enum  ZSpellType implements ZEquipmentType<ZSpell>, IButton {
    ...
    SPEED("Once per turn select a survivor in a zone without zombies. He may emmidiately perform a free move action up to 2 zones."),
    TRANSMUTATION("Once per turn the survivor discards an equipment of their choice from inventory. Draw an equipment card. He re re-organize inventory for free. Not a search action. Ahhhh! card played as usual"),
