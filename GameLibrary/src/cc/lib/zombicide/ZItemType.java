...
public enum ZItemType implements ZEquipmentType<ZItem> {
    ...
    WATER(true, ZEquipSlotType.BACKPACK, "Consume and gain 1 experience point"),
    SALTED_MEAT(true, ZEquipSlotType.BACKPACK, "Consume and gain 2 experience point"),
    APPLES(true, ZEquipSlotType.BACKPACK, "Consume and gain 3 experience point"),
