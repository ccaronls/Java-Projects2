...
/**
 * Base class for client and server forms.
 * 
 * @author ccaron
 *
 */
public abstract class Form {
    ...
    String toXML() {
        StringBuffer buffer = new StringBuffer("<" + Tag.SOCForm.name() + ">");
        if (rootElem != null)
            rootElem.toXML(buffer);
        buffer.append("</" + Tag.SOCForm.name() + ">");
        return buffer.toString();
    }
    ...
    private class XMLFormHandler extends DefaultHandler {
        ...
        FormElem newContainer(Attributes attribs) throws SAXException {
            ...
            if (type == null || type.equals("list")) {
                ...
                } else if (orient.startsWith("horz")) {
                    elem.type = FormElem.Type.HLISTCONTAINER;
                } else {
                    throw new SAXException("Unknown orientation for List Container '" + orient + "' must be horizontal or vertical");
                }
            } else {
