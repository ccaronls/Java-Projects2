...
public class EventCardComponent extends JComponent {
	...
	public void paint(Graphics g) {
		...
		if (card != null) {
			...
			Rectangle r = AWTUtils.drawWrapString(g, padding, padding, tw, card.getHelpText());
			...
			AWTUtils.drawJustifiedString(g, cx+cw/2, cy+padding*2+ovalHeight/2, Justify.CENTER, Justify.CENTER, String.valueOf(card.getProduction()));
			AWTUtils.drawWrapJustifiedString(g, cx+cw/2, cy+ch/3, minCardWidth, Justify.CENTER, card.getType().getNiceString());
