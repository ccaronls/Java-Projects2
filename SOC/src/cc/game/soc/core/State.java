...
//	INIT_GAME(false),
	...
	POSITION_SETTLEMENT_NOCANCEL(false, "Place a Settlement omn the board."),
	...
	POSITION_ROBBER_CANCEL(true, "Pick a hexagon for the Robber."),
    POSITION_ROBBER_NOCANCEL(false, "Pick a hexagon for the Robber."),
	...
	TAKE_OPPONENT_CARD(false, "Pick an opponent to take a card from."),
