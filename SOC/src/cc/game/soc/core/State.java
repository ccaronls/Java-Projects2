...
enum State {
    ...
    POSITION_NEUTRAL_SHIP_NOCANCEL(false, "Place a Ship on the board for the neutral player."),
    ...
    PROCESS_NEUTRAL_PLAYER(false, ""), // transition state
	;
	
	State(boolean canCancel, String helpTextId) {
