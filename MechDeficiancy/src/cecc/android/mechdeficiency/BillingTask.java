...
import cecc.android.mechdeficiency.BaseActivity;
...
public class BillingTask extends AsyncTask<String,Integer,Object> implements OnClickListener {
	...
	BillingTask(Op op, BaseActivity activity) {
		...
		try {
    		switch (op) {
    			...
    			case PURCHASE: {
    				...
    				activity.getPrefs().edit().putString(BaseActivity.PREF_PURCHASE_RANDOM_STRING, randomStr).commit();
			...
			switch (op) {
				...
				case PURCHASE: {
					...
					activity.startIntentSenderForResult(pendingIntent.getIntentSender(),
							   BaseActivity.REQUEST_PURCHASE, new Intent(), Integer.valueOf(0), Integer.valueOf(0),
							   Integer.valueOf(0));					
					break;
				}
				case QUERY_PURCHASABLES_DEBUG:
